...
class Ui_Tab1(object):
    def setupUi(self, Tab1) -> None:
        ...
        self.labelInfoTitle = QLabel(Tab1)
        ...
        self.labelInfoDetails = QLabel(Tab1)
        ...
        self.labelInfoCopyright = QLabel(Tab1)
    ...
    def retranslateUi(self, Tab1):
        ...
        self.labelInfoCopyright.setText(QCoreApplication.translate("Tab1", u"<html><head/><body><p align=\"center\"><span style=\" font-size:small; font-weight:700;\">Copyright J2Casa 2023. All Rights Reserved</span></p></body></html>", None))
    # retranslateUi
